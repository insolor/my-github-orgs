...
class CreateProjectV2FieldInput(BaseModel):
    ...
    name: str
    project_id: str = Field(alias="projectId")
    single_select_options: Optional[
...
class StartRepositoryMigrationInput(BaseModel):
    ...
    source_id: str = Field(alias="sourceId")
    source_repository_url: Optional[Any] = Field(
        alias="sourceRepositoryUrl", default=None
    )
...
AbortRepositoryMigrationInput.model_rebuild()
...
UnsubscribeFromNotificationsInput.model_rebuild()
...
UpdatePatreonSponsorabilityInput.model_rebuild()
...
WorkflowFileReferenceInput.model_rebuild()
